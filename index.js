...
app.post("/trained", function (req, res) {
  ...
  fs.writeFile(
    "./public/photoMooder/customModel.json",
    callData,
    "utf8",
    function (success) {
...
app.post("/interact", (req, res) => {
  ...
  for (var i = 0; i < imageData.length; i++) {
    var getDestinations = new Promise(function (resolve, reject) {
      var currInd = i;
      if (
        imageData[currInd]["imageMoods"][0] == query ||
        imageData[currInd]["imageMoods"][1] == query
      ) {
        ...
        flickr.photos.geo
          ...
          .then(function (response) {
            ...
            var thiscountry =
              destJSON["photo"]["location"]["country"]["_content"];
            var sendJSON = {
              name: thisname,
        ...
        var getPhotoTags = new Promise(function (resolve, reject) {
          ...
          flickr.tags
            ...
            .then(function (res) {
              ...
              for (
                var k = 0;
                k < tagsJSON["photo"]["tags"]["tag"].length;
                k++
              ) {
